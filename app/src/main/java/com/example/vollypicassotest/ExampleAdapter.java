...
public class ExampleAdapter extends RecyclerView.Adapter<ExampleAdapter.ExampleViewHolder> {
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ...
        holder.mTextViewCreator.setText("email: " + creatorName);
        holder.mTextViewLikes.setText("id: " + likeCount);
        holder.mTextViewFirstName.setText("First Name: " + firstName);
        holder.mTextViewLastName.setText("Last Name: " + lastName);
