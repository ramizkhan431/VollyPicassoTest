...
public class MainActivity extends AppCompatActivity implements ExampleAdapter.OnItemClickListener {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                String creatorName = hit.getString("email");
                                ...
                                mExampleList.add(new ExampleItem(imageUrl, creatorName,likeCount,firstName,lastName));
                            }
    ...
    public void onItemClick(int position) {
        ...
        detailIntent.putExtra(EXTRA_FIRSTNAME, clickedItem.getFirstName());
        detailIntent.putExtra(EXTRA_LASTNAME, clickedItem.getLastName());
